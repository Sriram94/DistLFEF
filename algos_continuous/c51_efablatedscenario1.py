...
def train(actor, critic, h_head, target_critic, actor_opt, critic_opt, h_opt, buffer, support, predictor):
    ...
    for ep in range(500):
        ...
        while not done:
            ...
            if len(buffer) > BATCH_SIZE:
                train(actor, critic, h_head, target_critic, actor_opt, critic_opt, h_opt, buffer, support, predictor)
